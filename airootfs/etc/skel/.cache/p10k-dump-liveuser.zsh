typeset -g __p9k_cached_param_pat=$'1.19.8\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-A\'\'\C-A${#parameters[(I)POWERLEVEL9K_*]}\C-A${(%):-%n%#}\C-A$GITSTATUS_LOG_LEVEL\C-A$GITSTATUS_ENABLE_LOGGING\C-A$GITSTATUS_DAEMON\C-A$GITSTATUS_NUM_THREADS\C-A$GITSTATUS_CACHE_DIR\C-A$GITSTATUS_AUTO_INSTALL\C-A${ZLE_RPROMPT_INDENT:-1}\C-A$__p9k_sh_glob\C-A$__p9k_ksh_arrays\C-A$ITERM_SHELL_INTEGRATION_INSTALLED\C-A${PROMPT_EOL_MARK-%B%S%#%s%b}\C-A$+commands[locale]\C-A$langinfo[CODESET]\C-A${(M)VTE_VERSION:#(<1-4602>|4801)}\C-A$DEFAULT_USER\C-A$P9K_SSH\C-A$+commands[uname]\C-A$__p9k_root_dir\C-A$functions[p10k-on-init]\C-A$functions[p10k-on-pre-prompt]\C-A$functions[p10k-on-post-widget]\C-A$functions[p10k-on-post-prompt]\C-A$+commands[git]\C-A$terminfo[colors]\C-A${+_z4h_iterm_cmd}\C-A$_z4h_can_save_restore_screen${POWERLEVEL9K_BACKGROUND-\C-A}\C-A${POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_COMMAND_EXECUTION_TIME_FORMAT-\C-A}\C-A${POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION-\C-A}\C-A${POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD-\C-A}\C-A${POWERLEVEL9K_CONFIG_FILE-\C-A}\C-A${POWERLEVEL9K_CONTEXT_DEFAULT_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE-\C-A}\C-A${POWERLEVEL9K_CONTEXT_SUDO_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_CONTEXT_TEMPLATE-\C-A}\C-A${POWERLEVEL9K_DIR_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_DISABLE_HOT_RELOAD-\C-A}\C-A${POWERLEVEL9K_INSTANT_PROMPT-\C-A}\C-A${POWERLEVEL9K_LEFT_LEFT_WHITESPACE-\C-A}\C-A${POWERLEVEL9K_LEFT_PROMPT_ELEMENTS-\C-A}\C-A${POWERLEVEL9K_LEFT_RIGHT_WHITESPACE-\C-A}\C-A${POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR-\C-A}\C-A${POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR-\C-A}\C-A${POWERLEVEL9K_PROMPT_ADD_NEWLINE-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_PROMPT_CHAR_OVERWRITE_STATE-\C-A}\C-A${POWERLEVEL9K_RIGHT_LEFT_WHITESPACE-\C-A}\C-A${POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS-\C-A}\C-A${POWERLEVEL9K_RIGHT_RIGHT_WHITESPACE-\C-A}\C-A${POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR-\C-A}\C-A${POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR-\C-A}\C-A${POWERLEVEL9K_TIME_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_TIME_FORMAT-\C-A}\C-A${POWERLEVEL9K_TIME_UPDATE_ON_COMMAND-\C-A}\C-A${POWERLEVEL9K_TRANSIENT_PROMPT-\C-A}\C-A${POWERLEVEL9K_VCS_BRANCH_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_COMMITS_AHEAD_MAX_NUM-\C-A}\C-A${POWERLEVEL9K_VCS_COMMITS_BEHIND_MAX_NUM-\C-A}\C-A${POWERLEVEL9K_VCS_COMMIT_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_CONTENT_EXPANSION-\C-A}\C-A${POWERLEVEL9K_VCS_DIRTY_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_VCS_GIT_HOOKS-\C-A}\C-A${POWERLEVEL9K_VCS_INCOMING_CHANGESFORMAT_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_LOADING_TEXT-\C-A}\C-A${POWERLEVEL9K_VCS_MAX_SYNC_LATENCY_SECONDS-\C-A}\C-A${POWERLEVEL9K_VCS_OUTGOING_CHANGESFORMAT_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_STAGED_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_UNSTAGED_ICON-\C-A}\C-A${POWERLEVEL9K_VCS_UNTRACKED_ICON-\C-A}\C-A${POWERLEVEL9K_VIRTUALENV_FOREGROUND-\C-A}\C-A${POWERLEVEL9K_VIRTUALENV_LEFT_DELIMITER-\C-A}\C-A${POWERLEVEL9K_VIRTUALENV_RIGHT_DELIMITER-\C-A}\C-A${POWERLEVEL9K_VIRTUALENV_SHOW_PYTHON_VERSION-\C-A}\C-A${POWERLEVEL9K_VISUAL_IDENTIFIER_EXPANSION-\C-A}'
typeset -g __p9k_cached_param_sig=$'1.19.8\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-A\'\'\C-A63\C-Aliveuser%\C-A\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/home/liveuser/.local/share/zinit/plugins/romkatv---powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-A\C-A3\C-Ad h m s\C-A0\C-A5\C-A/home/liveuser/.p10k.zsh\C-A\C-A%F{7}%n%f%F{242}@%m%f\C-A\C-A%F{242}%n@%m%f\C-A4\C-Atrue\C-Averbose\C-A\C-Acontext\C-Bdir\C-Bvcs\C-Bcommand_execution_time\C-Bvirtualenv\C-Bprompt_char\C-A\C-A\C-A \C-Afalse\C-A❮\C-A1\C-A❯\C-A1\C-A❮\C-A1\C-A❮\C-A5\C-A❯\C-A5\C-A❮\C-A5\C-Afalse\C-A\C-A\C-A\C-A\C-A \C-A242\C-A%D{%H:%M:%S}\C-Afalse\C-Aoff\C-A\C-A1\C-A1\C-A@\C-A${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }\C-A*\C-A242\C-Avcs-detect-changes\C-Bgit-untracked\C-Bgit-aheadbehind\C-A6\C-A:⇣\C-A\C-A0\C-A6\C-A:⇡\C-A\C-A\C-A\C-A242\C-A\C-A\C-Afalse\C-A'
function _p9k_preinit() {
    (( 1 )) || { unfunction _p9k_preinit; return 1 }
    [[ $ZSH_VERSION == 5.9 ]]                      || return
    [[ -r /home/liveuser/.local/share/zinit/plugins/romkatv---powerlevel10k/gitstatus/gitstatus.plugin.zsh ]]             || return
    builtin source /home/liveuser/.local/share/zinit/plugins/romkatv---powerlevel10k/gitstatus/gitstatus.plugin.zsh _p9k_ || return
...
typeset -g _POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_FOREGROUND=1
...
typeset -g _POWERLEVEL9K_DIR_FOREGROUND=4
...
typeset -g _POWERLEVEL9K_VCS_OUTGOING_CHANGESFORMAT_FOREGROUND=6
...
typeset -g _POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{7}%n%f%F{242}@%m%f'
...
typeset -g -A _p9k_cache=( [$'_p9k_color prompt_command_execution_time\C-@BACKGROUND\C-@red']=. [$'_p9k_color prompt_command_execution_time\C-@FOREGROUND\C-@yellow1']=003. [$'_p9k_color prompt_context_DEFAULT\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_context_DEFAULT\C-@FOREGROUND\C-@yellow']=003. [$'_p9k_color prompt_context_ROOT\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_context_ROOT\C-@FOREGROUND\C-@yellow']=003. [$'_p9k_color prompt_dir_HOME\C-@BACKGROUND\C-@blue']=. [$'_p9k_color prompt_dir_HOME\C-@FOREGROUND\C-@0']=004. [$'_p9k_color prompt_prompt_char_ERROR_VICMD\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_prompt_char_ERROR_VICMD\C-@FOREGROUND\C-@196']=001. [$'_p9k_color prompt_prompt_char_ERROR_VIINS\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_prompt_char_ERROR_VIINS\C-@FOREGROUND\C-@196']=001. [$'_p9k_color prompt_prompt_char_ERROR_VIVIS\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_prompt_char_ERROR_VIVIS\C-@FOREGROUND\C-@196']=001. [$'_p9k_color prompt_prompt_char_OK_VICMD\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_prompt_char_OK_VICMD\C-@FOREGROUND\C-@76']=005. [$'_p9k_color prompt_prompt_char_OK_VIINS\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_prompt_char_OK_VIINS\C-@FOREGROUND\C-@76']=005. [$'_p9k_color prompt_prompt_char_OK_VIVIS\C-@BACKGROUND\C-@0']=. [$'_p9k_color prompt_prompt_char_OK_VIVIS\C-@FOREGROUND\C-@76']=005. [$'_p9k_color prompt_ruler\C-@BACKGROUND\C-@']=. [$'_p9k_color prompt_ruler\C-@FOREGROUND\C-@']=. [$'_p9k_color prompt_vcs_LOADING\C-@BACKGROUND\C-@8']=. [$'_p9k_color prompt_vcs_LOADING\C-@FOREGROUND\C-@0']=242. [$'_p9k_get_icon \C-@LEFT_SEGMENT_END_SEPARATOR']=' .' [$'_p9k_get_icon \C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon \C-@RULER_CHAR']=─. [$'_p9k_get_icon \C-@VCS_BRANCH_ICON']=. [$'_p9k_get_icon \C-@VCS_STAGED_ICON']=. [$'_p9k_get_icon \C-@VCS_UNSTAGED_ICON']=. [$'_p9k_get_icon prompt_command_execution_time\C-@EXECUTION_TIME_ICON']=. [$'_p9k_get_icon prompt_command_execution_time\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_command_execution_time\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_command_execution_time\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_command_execution_time\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_command_execution_time\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_command_execution_time\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_command_execution_time\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_context_DEFAULT\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_context_DEFAULT\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_context_DEFAULT\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_context_DEFAULT\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_context_DEFAULT\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_context_DEFAULT\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_context_DEFAULT\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_context_ROOT\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_context_ROOT\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_context_ROOT\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_context_ROOT\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_context_ROOT\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_context_ROOT\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_context_ROOT\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_dir_DEFAULT\C-@FOLDER_ICON']=. [$'_p9k_get_icon prompt_dir_ETC\C-@ETC_ICON']=⚙. [$'_p9k_get_icon prompt_dir_HOME\C-@\C-A']=. [$'_p9k_get_icon prompt_dir_HOME\C-@HOME_ICON']=. [$'_p9k_get_icon prompt_dir_HOME\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_dir_HOME\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_dir_HOME\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_dir_HOME\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_dir_HOME\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_dir_HOME\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_dir_HOME\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_dir_HOME_SUBFOLDER\C-@HOME_SUB_ICON']=. [$'_p9k_get_icon prompt_empty_line\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_os_icon\C-@LINUX_ARCH_ICON']=Arc. [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_prompt_char_ERROR_VICMD\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_prompt_char_ERROR_VIINS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_prompt_char_ERROR_VIVIS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_prompt_char_OK_VICMD\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_prompt_char_OK_VIINS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_prompt_char_OK_VIVIS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_get_icon prompt_vcs_LOADING\C-@LEFT_LEFT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_vcs_LOADING\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL']=. [$'_p9k_get_icon prompt_vcs_LOADING\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL']=. [$'_p9k_get_icon prompt_vcs_LOADING\C-@LEFT_RIGHT_WHITESPACE\C-@ ']=. [$'_p9k_get_icon prompt_vcs_LOADING\C-@LEFT_SEGMENT_SEPARATOR']=. [$'_p9k_get_icon prompt_vcs_LOADING\C-@LEFT_SUBSEGMENT_SEPARATOR']=' .' [$'_p9k_get_icon prompt_vcs_LOADING\C-@VCS_LOADING_ICON']=. [$'_p9k_get_icon prompt_vcs_LOADING\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@ ']=' .' [$'_p9k_left_prompt_segment\C-@prompt_command_execution_time\C-@red\C-@yellow1\C-@EXECUTION_TIME_ICON\C-@4']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=48}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+50}}${_p9k__n:=51}${_p9k__c::="${P9K_CONTENT}"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lcommand_execution_time+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{003\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=4}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_context_DEFAULT\C-@0\C-@yellow\C-@\C-@1']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=8}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+10}}${_p9k__n:=11}${_p9k__c::=}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lcontext+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{003\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=1}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_context_ROOT\C-@0\C-@yellow\C-@\C-@1']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=12}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+14}}${_p9k__n:=15}${_p9k__c::="${P9K_CONTENT}"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lcontext+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{003\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=1}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_dir_HOME\C-@blue\C-@0\C-@\C-A\C-@2']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=16}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+18}}${_p9k__n:=19}${_p9k__c::="${P9K_CONTENT}"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1ldir+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{004\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=2}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_prompt_char_ERROR_VICMD\C-@0\C-@196\C-@\C-@6']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=40}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+42}}${_p9k__n:=43}${_p9k__c::="❮"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lprompt_char+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{001\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=6}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_prompt_char_ERROR_VIINS\C-@0\C-@196\C-@\C-@6']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=36}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+38}}${_p9k__n:=39}${_p9k__c::="❯"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lprompt_char+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{001\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=6}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_prompt_char_ERROR_VIVIS\C-@0\C-@196\C-@\C-@6']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=44}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+46}}${_p9k__n:=47}${_p9k__c::="❮"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lprompt_char+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{001\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=6}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_prompt_char_OK_VICMD\C-@0\C-@76\C-@\C-@6']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=24}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+26}}${_p9k__n:=27}${_p9k__c::="❮"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lprompt_char+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{005\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=6}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_prompt_char_OK_VIINS\C-@0\C-@76\C-@\C-@6']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=20}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+22}}${_p9k__n:=23}${_p9k__c::="❯"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lprompt_char+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{005\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=6}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_prompt_char_OK_VIVIS\C-@0\C-@76\C-@\C-@6']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=28}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+30}}${_p9k__n:=31}${_p9k__c::="❮"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lprompt_char+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{005\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=6}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_left_prompt_segment\C-@prompt_vcs_LOADING\C-@8\C-@0\C-@VCS_LOADING_ICON\C-@3']=$'${_p9k__n::=}${${${_p9k__bg:-0}:#NONE}:-${_p9k__n::=32}}${_p9k__n:=${${(M)${:-x}:#x($_p9k__bg|${_p9k__bg:-0})}:+34}}${_p9k__n:=35}${P9K_VISUAL_IDENTIFIER::=}${_p9k__c::="${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }"}${_p9k__c::=${_p9k__c//\C-M}}${_p9k__e::=${${_p9k__1lvcs+00}:-${${(%):-$_p9k__c%1(l.1.0)}[-1]}0}}}+}${${_p9k__e:#00}:+${${_p9k_t[$_p9k__n]/<_p9k__ss>/$_p9k__ss}/<_p9k__s>/$_p9k__s}${_p9k__c}%b%k%F{242\\}${${:-${_p9k__s::=%F{\\}}${_p9k__ss::= }${_p9k__sss::=%F{\\}}${_p9k__i::=3}${_p9k__bg::=}}+}}\C-@00' [$'_p9k_param \C-@LEFT_SEGMENT_END_SEPARATOR\C-@ ']=' .' [$'_p9k_param \C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param \C-@RULER_CHAR\C-@\\u2500']='\u2500.' [$'_p9k_param \C-@VCS_BRANCH_ICON\C-@\\uE0A0 ']=. [$'_p9k_param \C-@VCS_STAGED_ICON\C-@\\u271A']=. [$'_p9k_param \C-@VCS_UNSTAGED_ICON\C-@\\u25CF']=. [$'_p9k_param prompt_command_execution_time\C-@BACKGROUND\C-@red']=. [$'_p9k_param prompt_command_execution_time\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']='${P9K_CONTENT}.' [$'_p9k_param prompt_command_execution_time\C-@EXECUTION_TIME_ICON']=. [$'_p9k_param prompt_command_execution_time\C-@FOREGROUND\C-@yellow1']=3. [$'_p9k_param prompt_command_execution_time\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_command_execution_time\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_command_execution_time\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_command_execution_time\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_command_execution_time\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_command_execution_time\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_command_execution_time\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_command_execution_time\C-@PREFIX\C-@']=. [$'_p9k_param prompt_command_execution_time\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_command_execution_time\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_command_execution_time\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_command_execution_time\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_command_execution_time\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_context_DEFAULT\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_context_DEFAULT\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=. [$'_p9k_param prompt_context_DEFAULT\C-@FOREGROUND\C-@yellow']=yellow. [$'_p9k_param prompt_context_DEFAULT\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_context_DEFAULT\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_context_DEFAULT\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_context_DEFAULT\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_context_DEFAULT\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_context_DEFAULT\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_context_DEFAULT\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_context_DEFAULT\C-@PREFIX\C-@']=. [$'_p9k_param prompt_context_DEFAULT\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_context_DEFAULT\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_context_DEFAULT\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_context_DEFAULT\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_context_DEFAULT\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_context_ROOT\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_context_ROOT\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']='${P9K_CONTENT}.' [$'_p9k_param prompt_context_ROOT\C-@FOREGROUND\C-@yellow']=yellow. [$'_p9k_param prompt_context_ROOT\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_context_ROOT\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_context_ROOT\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_context_ROOT\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_context_ROOT\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_context_ROOT\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_context_ROOT\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_context_ROOT\C-@PREFIX\C-@']=. [$'_p9k_param prompt_context_ROOT\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_context_ROOT\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_context_ROOT\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_context_ROOT\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_context_ROOT\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_dir_DEFAULT\C-@FOLDER_ICON']=. [$'_p9k_param prompt_dir_ETC\C-@ETC_ICON\C-@\\u2699']='\u2699.' [$'_p9k_param prompt_dir_HOME\C-@ANCHOR_BOLD\C-@']=. [$'_p9k_param prompt_dir_HOME\C-@BACKGROUND\C-@blue']=. [$'_p9k_param prompt_dir_HOME\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']='${P9K_CONTENT}.' [$'_p9k_param prompt_dir_HOME\C-@FOREGROUND\C-@0']=4. [$'_p9k_param prompt_dir_HOME\C-@HOME_ICON']=. [$'_p9k_param prompt_dir_HOME\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_dir_HOME\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_dir_HOME\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_dir_HOME\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_dir_HOME\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_dir_HOME\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_dir_HOME\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_dir_HOME\C-@PATH_HIGHLIGHT_BOLD\C-@']=. [$'_p9k_param prompt_dir_HOME\C-@PATH_SEPARATOR\C-@/']=/. [$'_p9k_param prompt_dir_HOME\C-@PREFIX\C-@']=. [$'_p9k_param prompt_dir_HOME\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_dir_HOME\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_dir_HOME\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_dir_HOME\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_dir_HOME\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_dir_HOME_SUBFOLDER\C-@HOME_SUB_ICON']=. [$'_p9k_param prompt_empty_line\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_os_icon\C-@LINUX_ARCH_ICON\C-@Arc']=Arc. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=❮. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@FOREGROUND\C-@196']=1. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@PREFIX\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_prompt_char_ERROR_VICMD\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=❯. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@FOREGROUND\C-@196']=1. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@PREFIX\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_prompt_char_ERROR_VIINS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=❮. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@FOREGROUND\C-@196']=1. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@PREFIX\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_prompt_char_ERROR_VIVIS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=❮. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@FOREGROUND\C-@76']=5. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@PREFIX\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_prompt_char_OK_VICMD\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=❯. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@FOREGROUND\C-@76']=5. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@PREFIX\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_prompt_char_OK_VIINS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@BACKGROUND\C-@0']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']=❮. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@FOREGROUND\C-@76']=5. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@PREFIX\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_prompt_char_OK_VIVIS\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_ruler\C-@BACKGROUND\C-@']=. [$'_p9k_param prompt_ruler\C-@FOREGROUND\C-@']=. [$'_p9k_param prompt_vcs_CLEAN\C-@CONTENT_EXPANSION\C-@x']='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }.' [$'_p9k_param prompt_vcs_CONFLICTED\C-@CONTENT_EXPANSION\C-@x']='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }.' [$'_p9k_param prompt_vcs_LOADING\C-@BACKGROUND\C-@8']=. [$'_p9k_param prompt_vcs_LOADING\C-@CONTENT_EXPANSION\C-@${P9K_CONTENT}']='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }.' [$'_p9k_param prompt_vcs_LOADING\C-@CONTENT_EXPANSION\C-@x']='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }.' [$'_p9k_param prompt_vcs_LOADING\C-@FOREGROUND\C-@0']=242. [$'_p9k_param prompt_vcs_LOADING\C-@ICON_BEFORE_CONTENT\C-@']=. [$'_p9k_param prompt_vcs_LOADING\C-@LEFT_LEFT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_vcs_LOADING\C-@LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_vcs_LOADING\C-@LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL\C-@\C-A']=$'\C-A.' [$'_p9k_param prompt_vcs_LOADING\C-@LEFT_RIGHT_WHITESPACE\C-@\C-A ']=. [$'_p9k_param prompt_vcs_LOADING\C-@LEFT_SEGMENT_SEPARATOR\C-@\\uE0B0']=. [$'_p9k_param prompt_vcs_LOADING\C-@LEFT_SUBSEGMENT_SEPARATOR\C-@\\uE0B1']=' .' [$'_p9k_param prompt_vcs_LOADING\C-@PREFIX\C-@']=. [$'_p9k_param prompt_vcs_LOADING\C-@SELF_JOINED\C-@false']=false. [$'_p9k_param prompt_vcs_LOADING\C-@SHOW_ON_UPGLOB\C-@']=. [$'_p9k_param prompt_vcs_LOADING\C-@SUFFIX\C-@']=. [$'_p9k_param prompt_vcs_LOADING\C-@VCS_LOADING_ICON']=. [$'_p9k_param prompt_vcs_LOADING\C-@VISUAL_IDENTIFIER_EXPANSION\C-@${P9K_VISUAL_IDENTIFIER}']=. [$'_p9k_param prompt_vcs_LOADING\C-@WHITESPACE_BETWEEN_LEFT_SEGMENTS\C-@\C-A ']=$'\C-A .' [$'_p9k_param prompt_vcs_MODIFIED\C-@CONTENT_EXPANSION\C-@x']='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }.' [$'_p9k_param prompt_vcs_UNTRACKED\C-@CONTENT_EXPANSION\C-@x']='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }.' )
...
typeset -g _POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_FOREGROUND=5
...
typeset -g _POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND=1
...
typeset -g _POWERLEVEL9K_CONFIG_FILE=/home/liveuser/.p10k.zsh
...
typeset -g _POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_FOREGROUND=1
...
typeset -g _POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_FOREGROUND=5
...
typeset -g _POWERLEVEL9K_VCS_INCOMING_CHANGESFORMAT_FOREGROUND=6
...
typeset -g -A _p9k_dumped_instant_prompt_sigs=( [/home/liveuser:0:%]=1 )
...
typeset -g -a _p9k_t=( $'\n' $'%{\n%}' '' $'\n' '%b%k%f${(pl.${$((_p9k__clm-_p9k__ind))/#-*/0}..─.)}%k%f${_p9k_t[$((1+!_p9k__ind))]}' '${${:-${_p9k__x::=0}${_p9k__y::=1024}${_p9k__p::=$_p9k__lprompt$_p9k__rprompt}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$((_p9k__clm-_p9k__x-_p9k__ind-1))}}+}' $'${${_p9k__clm::=$COLUMNS}+}${${COLUMNS::=1024}+}${${_p9k__keymap::=${KEYMAP:-$_p9k__keymap}}+}%b%k%f${${_p9k__ind::=${${ZLE_RPROMPT_INDENT:-1}/#-*/0}}+}${_p9k_t[${_p9k__empty_line_i:-4}]}%{${_p9k__ipe-${_p9k_t[${_p9k__ruler_i:-1}]:+\n${(Q)${:-"$\'\\\\033\'\\\\[A"}}}}%}${(e)_p9k_t[${_p9k__ruler_i:-5}]}' '%b%k%F{003}' '%b%k%F{003}' '%b%k<_p9k__ss>%b%k%F{003}' '%b%k<_p9k__s>%b%k%F{003}' '%b%k%F{003}' '%b%k%F{003}' '%b%k<_p9k__ss>%b%k%F{003}' '%b%k<_p9k__s>%b%k%F{003}' '%b%k%F{004}' '%b%k%F{004}' '%b%k<_p9k__ss>%b%k%F{004}' '%b%k<_p9k__s>%b%k%F{004}' '%b%k%F{005}' '%b%k%F{005}' '%b%k<_p9k__ss>%b%k%F{005}' '%b%k<_p9k__s>%b%k%F{005}' '%b%k%F{005}' '%b%k%F{005}' '%b%k<_p9k__ss>%b%k%F{005}' '%b%k<_p9k__s>%b%k%F{005}' '%b%k%F{005}' '%b%k%F{005}' '%b%k<_p9k__ss>%b%k%F{005}' '%b%k<_p9k__s>%b%k%F{005}' '%b%k%F{242}' '%b%k%F{242}' '%b%k<_p9k__ss>%b%k%F{242}' '%b%k<_p9k__s>%b%k%F{242}' '%b%k%F{001}' '%b%k%F{001}' '%b%k<_p9k__ss>%b%k%F{001}' '%b%k<_p9k__s>%b%k%F{001}' '%b%k%F{001}' '%b%k%F{001}' '%b%k<_p9k__ss>%b%k%F{001}' '%b%k<_p9k__s>%b%k%F{001}' '%b%k%F{001}' '%b%k%F{001}' '%b%k<_p9k__ss>%b%k%F{001}' '%b%k<_p9k__s>%b%k%F{001}' '%b%k%F{003}' '%b%k%F{003}' '%b%k<_p9k__ss>%b%k%F{003}' '%b%k<_p9k__s>%b%k%F{003}' )
...
typeset -g _POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=3
...
typeset -g _POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_FOREGROUND=5
